...
#define kDefaultContentViewBackgroundColor [UIColor blackColor]
...
- (void)viewWillLayoutSubviews {
    ...
    frame.origin.x = 0.0;
    frame.origin.y = self.tabLocation ? 50.0 : self.view.frame.size.height - self.tabHeight + 50;
    ...
    frame.origin.x = 0.0;
    frame.origin.y = self.tabLocation ? self.tabHeight + 50 : 50.0;
    frame.size.width = self.view.bounds.size.width;
...
- (void)defaultSettings {
    ...
    _tabWidth = self.kDefaultTabWidth;
...
- (void)reloadData {
    ...
    self.kDefaultTabWidth = 320.0 / [self.dataSource numberOfTabsForViewPager:self];
    ...
    if ([self.delegate respondsToSelector:@selector(viewPager:valueForOption:withDefault:)]) {
        ...
        _tabWidth = [self.delegate viewPager:self valueForOption:ViewPagerOptionTabWidth withDefault:self.kDefaultTabWidth];
